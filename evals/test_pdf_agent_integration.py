...
def helpfulness_metric(evaluation_model: AnthropicModel) -> GEval:
    ...
    return GEval(
        ...
        criteria=(
            ...
            "The response is generated by an AI agent that has read the full PDF document. "
            "Consider: Does it directly address the question? "
            "Is the information well-structured and specific? "
            "Does it include relevant data points and details? "
            "Do NOT penalise for information that cannot be independently verified - "
            "assume the agent has accurate access to the document."
        ),
        evaluation_params=[
